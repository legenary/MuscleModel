...
public:
	Spring(btRigidBody* body1, btRigidBody* body2, btTransform frameInParent, btTransform frameInChild, bool isLinear = true);
	...
	void initializeLayer(btScalar E_skin, btScalar damping);
