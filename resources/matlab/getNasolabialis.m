...
node_pos(36, :) = mean([foot1; foot2]);
len = norm(node_pos(36, :) - node_pos(4, :));

node_pos(37, :) = node_pos(8, :) + (node_pos(8, :) - node_pos(9, :))...
                                 /norm(node_pos(8, :) - node_pos(9, :))*len;
node_pos(38, :) = node_pos(12, :) + (node_pos(12, :) - node_pos(13, :))...
                                 /norm(node_pos(12, :) - node_pos(13, :))*len;
node_pos(39, :) = node_pos(19, :) + (node_pos(19, :) - node_pos(20, :))...
                                 /norm(node_pos(19, :) - node_pos(20, :))*len;
node_pos(40, :) = node_pos(26, :) + (node_pos(26, :) - node_pos(27, :))...
                                 /norm(node_pos(26, :) - node_pos(27, :))*len;

s1 = node_pos(1, :); e1 = node_pos(36, :); 
s2 = node_pos(26, :); e2 = node_pos(40, :); 
[foot1, foot2] = getCommonFootOfPerpendicularLine(s1, e1, s2, e2);
...
constrcution_index = [
    ...
    0 40; 40 26; 26 27; 27 28; 28 29; 29 30; 31 32;
];
