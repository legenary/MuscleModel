...
% between C D E row
node_idx{ 7} = [10 11 19];       node_height( 8) = 1;
node_idx{ 8} = [11 12 19 20];   node_height( 9) = 0.9;
node_idx{ 9} = [12 13 20 21];   node_height(10) = 0.6;
node_idx{10} = [13 14 21 22];   node_height(11) = 0.3;
node_idx{11} = [14 15 22 23];   node_height(12) = 0;
node_idx{12} = [15 16 23 24];   node_height(13) = -0.3;
node_idx{13} = [16 17 24 25];   node_height(14) = -0.6;

node_idx{14} = [18 19 27];      node_height(16) = 1;
node_idx{15} = [19 20 27 28];   node_height(17) = 0.9;
node_idx{16} = [20 21 28 29];   node_height(18) = 0.6;
node_idx{17} = [21 22 29 30];   node_height(19) = 0.3;
node_idx{18} = [22 23 30 31];   node_height(20) = 0;
node_idx{19} = [23 24 31 32];   node_height(21) = -0.3;
node_idx{20} = [24 25 32 33];   node_height(22) = -0.6;
